...
Similarly to the [simple HTTP forwarder]({{<ref "/fundamentals/apis/remote#access-token-requirements" >}}), the allowed values for the token type are *User*, *Client*, *UserOrClient*. 
