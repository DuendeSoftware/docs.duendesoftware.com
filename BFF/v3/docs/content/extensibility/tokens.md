...
{{% notice note %}}
You can also supply client assertions to the token management library. See this [sample]({{< ref-idsrv "/samples/basics#mvc-client-with-jar-and-jwt-based-authentication" >}}) for JWT-based client authentication.
{{% /notice %}}
