...
This upgrade guide covers upgrading from Duende IdentityServer v5.1 to v5.2.
...
```
dotnet ef migrations add Update_DuendeIdentityServer_v52 -c ConfigurationDbContext -o Data/Migrations/IdentityServer/ConfigurationDb
```
