...
## Single Deployment
A single deployment acts as a single OpenID Connect / OAuth authority. It can consist of multiple phsyical nodes for load-balancing or fail-over purposes.


## Multiple Deployment
Can be either completely independent single deployments, or a single deployment that acts as multiple authorities (e.g. for branding, isolation or multi-tenancy reasons).