...
Whether you are using a [database](/identityserver/data/index.md) or a [custom store implementation](/identityserver/reference/v8/stores/index.md) for your configuration and operational data, you'll need to make some changes.
