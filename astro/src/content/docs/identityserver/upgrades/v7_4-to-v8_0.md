...
or purchase is necessary if you already have an active license. However, to make use of add-ons like [SAML](/identityserver/saml/index.mdx) 
or [Duende User Management](/identityserver/identity/user-management/index.mdx), a new license key file will be required to run IdentityServer v8 in production.
