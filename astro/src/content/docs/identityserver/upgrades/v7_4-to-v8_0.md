...
```xml
<PackageReference Include="Duende.IdentityServer.EntityFramework" Version="8.0"/>
<PackageReference Include="Duende.IdentityServer.AspNetIdentity" Version="8.0"/>
<PackageReference Include="Duende.IdentityServer.Configuration" Version="8.0"/>
```
