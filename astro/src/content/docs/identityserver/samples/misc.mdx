...
<LinkCard
  description="GitHub Repository for the Securing Azure Functions Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/various/JwtSecuredAzureFunction"
  title="Securing Azure Functions Sample"
 target="_blank"
/>
...
For step-by-step certificate generation using `mkcert`, hosts file setup, Kestrel configuration, and production
deployment patterns, see the [mTLS Setup Guide](/identityserver/tokens/mtls-setup.mdx).
...
<LinkCard
  description="GitHub Repository for the DPoP Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v8/DPoP"
  title="DPoP Sample"
  target="_blank"
/>
...
This sample shows how to enable [server-side sessions](/identityserver/ui/server-side-sessions/index.md) and configure the basic settings.
...
<LinkCard
  description="GitHub Repository for the Session Management Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v8/SessionManagement"
  title="Session Management Sample"
  target="_blank"
/>
...
<LinkCard
  description="GitHub Repository for the Session Migration Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v8/SessionMigration"
  title="Session Migration Sample"
  target="_blank"
/>