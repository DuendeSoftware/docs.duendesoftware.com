...
<CardGrid>
  <LinkCard
    ...
    description="Core IdentityServer package."
  />
  <LinkCard
    href="https://www.nuget.org/packages/Duende.IdentityServer.EntityFramework"
    title="Entity Framework Integration"
    description="EF Core persistence for configuration and operational data."
  />
  <LinkCard
    href="https://www.nuget.org/packages/Duende.IdentityServer.AspNetIdentity"
    title="ASP.NET Identity Integration"
    description="User management via ASP.NET Core Identity."
  />
</CardGrid>
...
<CardGrid>
    ...
    <LinkCard
        ...
        href="https://github.com/DuendeSoftware/products/tree/main/identity-server/templates/src/"
        title="Source Code"
    />
</CardGrid>
...
[Read more about the Entity Framework Core setup here.](/identityserver/data/providers/entityframework-core.md)
...
[Please read our ASP.NET Identity documentation](/identityserver/identity/aspnet-identity/index.md), to learn more about this integration.
