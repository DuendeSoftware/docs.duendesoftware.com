...
Diagnostics data is [written to logs periodically](/identityserver/reference/v8/options.md#diagnostics), and can be used by
...
* [`IdentityServerOptions`](/identityserver/reference/v8/options.md) configuration
...
* Basic server information
  * Host name
* [License Usage Summary](/identityserver/reference/v8/models/license-usage-summary.md) data
...
The IdentityServer diagnostics data is [written to logs periodically](/identityserver/reference/v8/options.md#diagnostics).
...
Diagnostics data [may be chunked](/identityserver/reference/v8/options.md#diagnostics), and you will need to concatenate chunks
