...
* **`GetPendingLoginRequestsForCurrentUserAsync`**
  ...
  Returns a collection of [BackchannelUserLoginRequest](/identityserver/reference/v7/models/ciba-login-request.md) objects
  which represent pending login requests for the current user.

* **`GetLoginRequestByInternalIdAsync`**

  Returns the [BackchannelUserLoginRequest](/identityserver/reference/v7/models/ciba-login-request.md) object for the id.
