...
Protection API. The [`DataProtectData` option](/identityserver/reference/v7/options.md#persistentgrants) can be used to
disable this
encryption.
...
[`AuthorizationCodeLifetime`](/identityserver/reference/v7/models/client.md#token) has
...
controlled by the [`AccessTokenLifetime`](/identityserver/reference/v7/models/client.md#token). Refresh token records also
always include
