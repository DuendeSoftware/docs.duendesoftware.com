...
`IDynamicClientRegistrationValidationResult`](/identityserver/reference/v7/dcr/models.md#idynamicclientregistrationvalidationresult), indicating success or
failure.
...
Each step is passed a [`DynamicClientRegistrationContext`](/identityserver/reference/v7/dcr/models.md#dynamicclientregistrationcontext) and returns a task
that returns an [`IStepResult`](/identityserver/reference/v7/dcr/models.md#istepresult). The `DynamicClientRegistrationContext` includes the client model
that will
