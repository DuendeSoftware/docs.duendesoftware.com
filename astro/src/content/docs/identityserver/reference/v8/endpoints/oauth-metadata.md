...
sidebar:
  ...
  order: 2
redirect_from:
  - /identityserver/reference/oauth-metadata/introspection/
---
...
Refer the [Discovery Endpoint](/identityserver/reference/v8/endpoints/discovery.md#issuer-name-and-path-base)
