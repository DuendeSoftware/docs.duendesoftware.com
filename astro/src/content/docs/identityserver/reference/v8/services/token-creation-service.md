...
redirect_from:
  ...
  - /identityserver/reference/services/token-creation-service/
---
...
additional claims, such as `IClaimService`, `ITokenService`, and [`IProfileService`](/identityserver/reference/v8/services/profile-service.md).
