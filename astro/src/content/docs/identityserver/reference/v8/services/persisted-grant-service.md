...
redirect_from:
  ...
  - /identityserver/reference/services/persisted-grant-service/
---
...
```csharp
    ...
    public interface IPersistedGrantService
    {
        ...
        /// <returns></returns>
        Task<IReadOnlyCollection<Grant>> GetAllGrantsAsync(string subjectId, CancellationToken ct);
        ...
        /// <returns></returns>
        Task RemoveAllGrantsAsync(string subjectId, CancellationToken ct, string? clientId = null, string? sessionId = null);
    }
```
