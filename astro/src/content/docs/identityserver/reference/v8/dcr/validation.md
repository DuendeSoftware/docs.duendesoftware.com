...
redirect_from:
  ...
  - /identityserver/configuration/dcr/reference/
  - /identityserver/reference/dcr/validation/
---
...
`IDynamicClientRegistrationValidationResult`](/identityserver/reference/v8/dcr/models.md#idynamicclientregistrationvalidationresult), indicating success or
failure.
...
Each step is passed a [`DynamicClientRegistrationContext`](/identityserver/reference/v8/dcr/models.md#dynamicclientregistrationcontext) and returns a task
that returns an [`IStepResult`](/identityserver/reference/v8/dcr/models.md#istepresult). The `DynamicClientRegistrationContext` includes the client model
that will
