...
redirect_from:
  ...
  - /identityserver/configuration/dcr/reference/processing/
  - /identityserver/reference/dcr/processing/
---
...
is also responsible for passing the finished `Client` to the [store](/identityserver/reference/v8/dcr/store.md)
