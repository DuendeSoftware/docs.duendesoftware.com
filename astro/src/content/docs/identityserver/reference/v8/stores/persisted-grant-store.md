...
Protection API. The [`DataProtectData` option](/identityserver/reference/v8/options.md#persistentgrants) can be used to
disable this
encryption.
...
[`AuthorizationCodeLifetime`](/identityserver/reference/v8/models/client.md#token) has
...
controlled by the [`AccessTokenLifetime`](/identityserver/reference/v8/models/client.md#token). Refresh token records also
always include
