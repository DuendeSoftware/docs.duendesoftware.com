...
redirect_from:
  ...
  - /identityserver/v6/reference/stores/backchannel_auth_request_store/
  - /identityserver/v7/reference/stores/backchannel_auth_request_store/
  - /identityserver/reference/stores/backchannel-auth-request-store/
---
...
public interface IBackChannelAuthenticationRequestStore
{
    ...
    /// Gets the requests.
    /// </summary>
    Task<IReadOnlyCollection<BackChannelAuthenticationRequest>> GetLoginsForUserAsync(string subjectId, CancellationToken ct, string? clientId = null);
