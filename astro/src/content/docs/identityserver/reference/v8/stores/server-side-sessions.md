...
redirect_from:
  ...
  - /identityserver/v6/reference/stores/server_side_sessions/
  - /identityserver/v7/reference/stores/server_side_sessions/
  - /identityserver/reference/stores/server-side-sessions/
---
...
:::note
The `Ticket` property contains a copy of all the values (and more) and is considered authoritative by IdentityServer,
