...
redirect_from:
  ...
  - /identityserver/reference/validators/custom-authorize-request-validator/
---
...
public interface ICustomAuthorizeRequestValidator
{
    ...
    Task ValidateAsync(CustomAuthorizeRequestValidationContext context, CancellationToken ct);
}
```
