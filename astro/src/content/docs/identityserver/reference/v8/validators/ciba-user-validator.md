...
redirect_from:
  ...
  - /identityserver/reference/validators/ciba-user-validator/
---
...
* **`ValidateRequestAsync(BackchannelAuthenticationUserValidatorContext userValidatorContext, CancellationToken ct)`**
