...
sidebar:
  ...
  order: 1
redirect_from:
  - /identityserver/usermanagement/authentication/overview/
---
...
<LinkCard title="OTP Authentication" href="/identityserver/identity/user-management/authentication/otp" description="Implement passwordless login via email or SMS one-time codes." />
...
* Works with any RFC 6238-compliant authenticator app, including [Microsoft Authenticator](https://www.microsoft.com/en-us/security/mobile-authenticator-app), [Google Authenticator](https://support.google.com/accounts/answer/1066447), [Authy](https://authy.com/), and [1Password](https://1password.com/)
...
<LinkCard title="TOTP Authentication" href="/identityserver/identity/user-management/authentication/totp" description="Add a second factor using authenticator apps and time-based codes." />
...
<LinkCard title="Password Authentication" href="/identityserver/identity/user-management/authentication/passwords" description="Implement traditional username and password login with PBKDF2 hashing and configurable complexity rules." />
...
<LinkCard title="External Authentication" href="/identityserver/identity/user-management/authentication/external" description="Federate login with external identity providers using OAuth 2.0 and OpenID Connect." />
...
<LinkCard title="Passkeys Authentication" href="/identityserver/identity/user-management/authentication/passkeys" description="Implement phishing-resistant WebAuthn/FIDO2 authentication with biometrics or hardware keys." />
...
<LinkCard title="Recovery Codes" href="/identityserver/identity/user-management/authentication/recovery-codes" description="Generate and use single-use backup codes for account recovery when the primary 2FA method is unavailable." />
...
Authenticate with a password first, then check whether the user has a TOTP authenticator enrolled. Passwords can also expire; when they do, `TryAuthenticateAsync` returns `PasswordAuthenticationResult.Expired` so you can redirect the user to a password-change page. See the [passwords page](./passwords.mdx) for details on configuring expiry.
...
<LinkCard title="Security Considerations" href="/identityserver/identity/user-management/fundamentals/security" description="Data protection, password hashing parameters, throttling configuration, and passkey option reference." />
