...
sidebar:
  ...
  order: 5
redirect_from:
  - /identityserver/usermanagement/authentication/external/
---
...
For a full comparison that includes passkeys and TOTP, see the [Authentication Overview](/identityserver/identity/user-management/authentication/overview.mdx).
