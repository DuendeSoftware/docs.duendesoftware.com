...
<CardGrid>
  ...
  />
  <LinkCard
    href="https://www.nuget.org/packages/Duende.UserManagement.IdentityServer8"
    title="NuGet Package"
...
<CardGrid>
  <LinkCard title="Getting Started" href="/identityserver/identity/user-management/getting-started" description="Add User Management to an ASP.NET Core app with a working OTP login flow." />
  <LinkCard title="IdentityServer Integration" href="/identityserver/identity/user-management/identityserver-integration" description="Add User Management to an existing or new IdentityServer deployment." />
  <LinkCard title="Authentication Flows" href="/identityserver/identity/user-management/authentication/overview" description="Compare OTP, TOTP, passkeys, passwords, external providers, and recovery codes." />
  <LinkCard title="Configuration Reference" href="/identityserver/identity/user-management/reference/configuration" description="All configuration options for authentication, profiles, and membership modules." />
