...
the [IdentityServerOptions](/identityserver/reference/v8/options.md#logging).
:::
...
![A diagram showing how token exchange works](images/token_exchange.svg)
...
your [profile service](/identityserver/reference/v8/services/profile-service.md) must know about it. The following simple
