...
You can hook into the token request pipeline by implementing the [ICustomTokenRequestValidator](/identityserver/reference/v8/validators/custom-token-request-validator.md) interface.
