...
This information is provided by the [LogoutRequest](/identityserver/reference/v8/services/interaction-service.md#logoutrequest) class and will provide your logout page data needed for the logout workflow.
...
The `logoutId` value can be exchanged with the `GetLogoutContextAsync` API on the [interaction service](/identityserver/reference/v8/services/interaction-service.md) to obtain a `LogoutRequest` object.
