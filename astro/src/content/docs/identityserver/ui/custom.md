...
Duende IdentityServer provides the [authorize interaction response generator](/identityserver/reference/v8/response-handling/authorize-interaction-response-generator.md) extensibility point to allow overriding or controlling the response from the authorize endpoint.
