...
<CardGrid>
  <LinkCard
    href="/identityserver/fundamentals/"
    title="Fundamentals"
    description="Learn what you need to bring to IdentityServer: UI, data stores, and identity/profile storage — plus ready-made options for each."
  />
  <LinkCard
  ...
  <LinkCard
    ...
    title="Multi-Tenancy (Spaces)"
    description="Host multiple isolated IdentityServer security domains in a single deployment."
  />
  <LinkCard
...
Duende IdentityServer is source-available, but **requires a paid [license](/general/licensing.md) for production use.**
