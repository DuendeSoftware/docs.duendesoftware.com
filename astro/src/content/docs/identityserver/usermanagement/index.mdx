...
You can add User Management to a new IdentityServer deployment or integrate it into an existing one. You adopt User Management incrementally: enable only the modules you need today and add more later.
