...
For a full comparison that includes passkeys and TOTP, see the [Authentication Overview](/identityserver/usermanagement/authentication/overview.mdx).
...
:::note
These are just a few examples. Any OAuth 2.0 or OpenID Connect provider can be used with User Management. For a broader list of third-party authentication providers and configuration guidance, see the [IdentityServer login documentation](/identityserver/ui/login/index.md).
:::
