...
from a copy of
the [reference implementation of Quickstart 4](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v8/Quickstarts/4_EntityFramework).
...
data as a source of claims data. [See here](/identityserver/reference/v8/services/profile-service.md) for more details on
the profile service.
