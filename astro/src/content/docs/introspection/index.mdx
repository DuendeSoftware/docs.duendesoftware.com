...
<CardGrid>
  <LinkCard
    ...
    title="Options"
    description="Full reference for all OAuth2IntrospectionOptions properties."
  />
  <LinkCard
    href="/introspection/events/"
    title="Events"
    description="Hook into token validation, client assertion, and request events."
  />
  <LinkCard
    href="/introspection/extensibility/"
    title="Extensibility"
    description="Custom token retrieval, cache key generation, and multi-scheme setup."
  />
  <LinkCard
    href="/introspection/troubleshooting/"
    title="Troubleshooting"
    description="Diagnose 401 errors, empty claims, discovery failures, and more."
  />
</CardGrid>
