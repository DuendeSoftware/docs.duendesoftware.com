...
- [Decision Guide: BFF vs Direct API Access](/general/guides/bff-vs-direct) — When to use the BFF pattern versus letting the browser hold tokens directly
