...
### Anti-Forgery Token Validation Failures
...
### CORS Errors With BFF Endpoints
...
### Session Expiration Causing Silent Failures
...
### Blazor WASM — Token Not Available in Components
...
### 302 Redirect Instead of 401 on API Endpoints
...
### Cookie Size Exceeding Browser Limits
...
<CardGrid>
  <LinkCard
    ...
    description="Correct initial setup."
  />
  <LinkCard
    href="/bff/getting-started/blazor/"
    title="Getting Started: Blazor"
    description="Blazor-specific configuration."
  />
  <LinkCard
    href="/bff/fundamentals/apis/local/"
    title="Local APIs"
    description="CSRF protection for embedded API endpoints."
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Production session persistence."
  />
  <LinkCard
    href="/bff/fundamentals/tokens/"
    title="Token Management"
    description="Access token refresh and revocation."
  />
  <LinkCard
    href="/bff/architecture/third-party-cookies/"
    title="Third-Party Cookies"
    description="Browser cookie restrictions and BFF."
  />
  <LinkCard
