...
including their OpenID Connect configuration, BFF Configuration, and Remote APIs. 
...
- `remoteApis`
  Remote APIs for this frontend.
  Type: RemoteApiConfiguration object. ([see below](#remoteapiconfiguration-json-properties)).
...
- `requiredTokenType`
  ...
  Possible values: `"None"`, `"User"`, `"Client"`, `"UserOrClient"`, `"UserOrNone"`  
  Default: `"User"`
...
- `userAccessTokenParameters`
  Object. Parameters for retrieving a user access token ([see below](#useraccesstokenparameters-json-properties)).
...
- `sameSite`
  String. The SameSite attribute of the cookie.  Defaults to `"Strict"`.  
