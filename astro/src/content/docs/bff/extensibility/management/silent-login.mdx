...
:::note[How this endpoint works]
See [Silent Login Endpoint](/bff/fundamentals/session/management/silent-login/) for an explanation of the silent login flow and usage.
:::
