...
See [Back-Channel Logout Endpoint](/bff/fundamentals/session/management/back-channel-logout/) for an explanation of how server-to-server logout works and how to configure it.
:::
