...
import { Code, Steps, CardGrid, LinkCard } from "@astrojs/starlight/components";
...
<CardGrid>
  <LinkCard
    ...
    title="Single Frontend Getting Started"
    description="Simpler setup for a single SPA."
  />
  <LinkCard
    href="/bff/fundamentals/blazor/"
    title="Blazor Fundamentals"
    description="Rendering modes, data access patterns, and auth state."
  />
  <LinkCard
    href="/bff/fundamentals/apis/local/"
    title="Local APIs"
    description="Embedding API endpoints in the BFF host."
  />
  <LinkCard
    href="/bff/fundamentals/tokens/"
    title="Token Management"
    description="How BFF handles access token refresh automatically."
  />
  <LinkCard
    href="/bff/fundamentals/session/server-side-sessions/"
    title="Server-Side Sessions"
    description="Persisting sessions with Entity Framework."
  />
  <LinkCard
    href="/accesstokenmanagement/"
    title="Access Token Management"
    description="The underlying token lifecycle library."
  />
  <LinkCard
    href="/bff/troubleshooting/"
    title="Troubleshooting"
    description="Common Blazor BFF issues and fixes."
  />
</CardGrid>
