...
<CardGrid>
  <LinkCard
    href="/bff/getting-started/multi-frontend/"
    title="Multiple Frontends"
    description="Serve several SPAs from the same BFF host."
  />
  <LinkCard
    href="/bff/getting-started/blazor/"
    title="Blazor Applications"
    description="BFF setup for Blazor Server and WASM."
  />
  <LinkCard
    href="/bff/fundamentals/apis/local/"
    title="Local APIs"
    description="Full reference for embedded API endpoints and CSRF protection."
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Persistent session configuration."
  />
  <LinkCard
    href="/accesstokenmanagement/"
    title="Access Token Management"
    description="The underlying token lifecycle library used by BFF."
  />
</CardGrid>
