...
- **Single YARP proxy for all frontends:**
  You can set up a single YARP proxy for all frontends, as shown in the [Single Frontend Guide](/bff/getting-started/single-frontend.mdx#5-adding-remote-apis).
...
Server side session configuration is the same as in the single frontend scenario. See the [Single Frontend Guide](/bff/getting-started/single-frontend.mdx#6-adding-server-side-sessions) for details.
