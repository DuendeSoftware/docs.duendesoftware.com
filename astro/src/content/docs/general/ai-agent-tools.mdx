...
If you are building your own MCP server and want to secure it with OpenID Connect and OAuth, start with the [IdentityServer AI & MCP guidance](/identityserver/ai/index.mdx).
:::
