...
<Tabs>
  <TabItem label="VS Code">
    You can register the MCP server [in your user settings](https://code.visualstudio.com/docs/agent-customization/mcp-servers#_add-an-mcp-server) to make it available in any workspace, or add a `.vscode/mcp.json` file to your workspace:
