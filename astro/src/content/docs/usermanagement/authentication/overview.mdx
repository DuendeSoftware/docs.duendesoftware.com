...
<LinkCard title="OTP Authentication" href="/usermanagement/authentication/otp" description="Implement passwordless login via email or SMS one-time codes." />
...
<LinkCard title="TOTP Authentication" href="/usermanagement/authentication/totp" description="Add a second factor using authenticator apps and time-based codes." />
...
<LinkCard title="Password Authentication" href="/usermanagement/authentication/passwords" description="Implement traditional username and password login with PBKDF2 hashing and configurable complexity rules." />
...
<LinkCard title="External Authentication" href="/usermanagement/authentication/external" description="Federate login with external identity providers using OAuth 2.0 and OpenID Connect." />
...
<LinkCard title="Passkeys Authentication" href="/usermanagement/authentication/passkeys" description="Implement phishing-resistant WebAuthn/FIDO2 authentication with biometrics or hardware keys." />
...
<LinkCard title="Recovery Codes" href="/usermanagement/authentication/recovery-codes" description="Generate and use single-use backup codes for account recovery when the primary 2FA method is unavailable." />
...
<LinkCard title="Security Considerations" href="/usermanagement/fundamentals/security" description="Data protection, password hashing parameters, throttling configuration, and passkey option reference." />
