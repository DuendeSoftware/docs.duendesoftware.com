...
The custom validator is used by registering it with the DI container. Multiple `IPasswordValidator` implementations can be registered. You can register the validator directly with:
