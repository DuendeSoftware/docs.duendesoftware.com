...
```
:::note
See the [reference](/identityserver/v5/reference/models/identity_resource) section for more information on *IdentityResource*.
:::
...
:::note
See the [reference](/identityserver/v5/reference/models/client) section for more information on the *Client* class.
:::
...
and present that to your implementation of the [profile service](/identityserver/v5/reference/services/profile_service).