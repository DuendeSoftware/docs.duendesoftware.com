...
This information is provided by the [LogoutRequest](/identityserver/v5/reference/services/interaction_service#logoutrequest) class and will provide your logout page data needed for the logout workflow.
...
The *logoutId* value can be exchanged with the *GetLogoutContextAsync* API on the [interaction service](/identityserver/v5/reference/services/interaction_service) obtain a *LogoutRequest* object.
