...
* OpenID Connect Session Management 1.0 - draft 30 ([spec](https://openid.net/specs/openid-connect-session-1_0.html))
...
* OAuth 2.0 Authorization Server Issuer Identifier in Authorization Response ([RFC 9207](https://datatracker.ietf.org/doc/rfc9207/))