...
One approach to configuring CORS is to use the *AllowedCorsOrigins* collection on the [client configuration](/identityserver/v5/reference/models/client#authentication--session-management).
