...
* define an [API scope](/identityserver/v5/fundamentals/resources/api_scopes) (and optionally a resource)
...
* define an [identity](/identityserver/v5/fundamentals/resources/identity) resource, e.g. *openid*
* define an [API scope](/identityserver/v5/fundamentals/resources/api_scopes) (and optionally a resource)
