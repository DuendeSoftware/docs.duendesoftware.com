...
To add support for it, you need to implement and [register](/identityserver/v5/reference/di#additional-services) an implementation of the *IResourceOwnerPasswordValidator* interface:
