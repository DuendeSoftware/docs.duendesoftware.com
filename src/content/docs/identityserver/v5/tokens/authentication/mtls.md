...
Use the [DI extensions methods](/identityserver/v5/reference/di) to add the services to DI which contain a default implementation to do that either thumbprint or common-name based:
