...
## Source Code
As with all of these quickstarts you can find the source code for it in the [docs](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts) repository. 
The project for this quickstart is [Quickstart #1: Securing an API using Client Credentials](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts/1_ClientCredentials).
...
(see the full file [here](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts/1_ClientCredentials/src/IdentityServer/Config.cs)).
...
Loading the resource and client definitions happens in [Startup.cs](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts/1_ClientCredentials/src/IdentityServer/Startup.cs) - update the code to look like this
...
Configure the API application to run on *https://localhost:6001* only. You can do this by editing the [launchSettings.json](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts/1_ClientCredentials/src/Api/Properties/launchSettings.json) file inside the Properties folder. Change the application URL setting to be:
...
(full file can be found [here](https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v5/Quickstarts/1_ClientCredentials/src/Client/Program.cs))
