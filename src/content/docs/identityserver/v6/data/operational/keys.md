...
The [automatic key management](../fundamentals/keys/automatic_key_management) feature in Duende IdentityServer requires a store to persist keys that are dynamically created.
