...
### Client
A [client](../fundamentals/clients) is a piece of software that requests tokens from your IdentityServer - either for authenticating a user (requesting an identity token) or for accessing a resource (requesting an access token). A client must be first registered with your IdentityServer before it can request tokens.
...
In protocol terms, this scenario is called *Client Credentials Flow* and you can learn more about it in the issuing tokens [section](../tokens/requesting#machine-to-machine-communication) as well as in our [Quickstart](../quickstarts/1_client_credentials).
...
In protocol terms, this scenario is called *Authorization Code Flow* and you can learn more about it in the issuing tokens [section](../tokens/requesting#interactive-applications) as well as in our [Quickstart](../quickstarts/2_interactive).
...
### Resources
[Resources](../fundamentals/resources) are something you want to protect with your IdentityServer - either identity data of your users, or APIs. 
