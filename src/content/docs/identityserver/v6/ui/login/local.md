...
ASP.NET Identity (*isaspid*) [template](/identityserver/v6/overview/packaging#templates) includes a login page that shows how you
...
When IdentityServer redirects to the [LoginUrl](/identityserver/v6/ui/login), the user should arrive at this
...
:::note
While you can use any custom user database or identity management library for your users, we provide first class [integration support](/identityserver/v6/aspnet_identity) for ASP.NET Identity.
:::
