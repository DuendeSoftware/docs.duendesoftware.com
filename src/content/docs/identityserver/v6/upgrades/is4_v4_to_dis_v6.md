...
[Automatic key management](/identityserver/v6/fundamentals/keys/automatic_key_management) is now a built-in feature.

## Step 5: Update Database Schema (if needed)

If you are using a [database](/identityserver/v6/data) for your configuration and operational data, then there are database schema updates.
These include:
...
In Duende IdentityServer the [automatic key management](/identityserver/v6/fundamentals/keys/automatic_key_management) feature can manage those keys for you.
