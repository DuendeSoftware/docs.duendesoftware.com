...
One approach to configuring CORS is to use the *AllowedCorsOrigins* collection on the [client configuration](/identityserver/v6/reference/models/client#authentication--session-management).
