...
* [Support](/identityserver/v7/tokens/pop#demonstrating-proof-of-possession-at-the-application-layer-dpop) for [OAuth 2.0 Demonstrating Proof-of-Possession at the Application Layer (DPoP) ](https://datatracker.ietf.org/doc/draft-ietf-oauth-dpop/), a new OAuth specification for sender-constraining refresh tokens and access tokens.
