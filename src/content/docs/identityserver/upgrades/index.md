...
based stores you need to apply the upgrade and database migrations from [6.0 - 6.1](v6.0-to-v6.1). Then
...
There are changes to the stores which requires database schema updates. If you use the Entity Framework
based stores you need to apply the upgrade and database migrations from [6.2 - 6.3](v6.2-to-v6.3). If you
...
on use by default. Review the [list in the upgrade guide](v6.2-to-v6.3#step-4-breaking-changes) to check
if any of them affect your implementation.

Then continue with "Upgrading from version 6.3" below.

#### Upgrading from version 6.3
Follow the [upgrade guide version 6.3 - 7.0](v6.3-to-v7.0)