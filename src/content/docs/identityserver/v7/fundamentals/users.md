...
:::note
While you can use any custom user database or identity management library for your users, we provide [integration support](/identityserver/v7/aspnet_identity) for ASP.NET Identity.
:::
...
When a user must login, the client application will redirect the user to the protocol endpoint called the [authorization endpoint](/identityserver/v7/reference/endpoints/authorize) in your IdentityServer server to request authentication.
