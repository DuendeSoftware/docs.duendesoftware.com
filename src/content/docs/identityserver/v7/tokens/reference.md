...
the [persisted grant](../data/operational/grants) store and issues a unique identifier for this token
back to the client.

The consumer of the token must use the [introspection](../reference/endpoints/introspection) endpoint to
validate the token.
