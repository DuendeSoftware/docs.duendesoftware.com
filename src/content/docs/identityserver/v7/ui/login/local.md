...
ASP.NET Identity (`isaspid`) [template](../overview/packaging#templates) includes a login page that shows how you
...
When IdentityServer redirects to the [LoginUrl](../ui/login), the user should arrive at this
