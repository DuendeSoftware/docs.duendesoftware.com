...
<LinkCard
  description="GitHub Repository for the Custom Profile Service Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/ProfileService"
  title="Custom Profile Service Sample"
  target="_blank"
/>
...
<LinkCard
  description="GitHub Repository for the Step Up Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/StepUp"
  title="Step Up Sample"
  target="_blank"
/>
...
<LinkCard
  description="GitHub Repository for the SPA-style Login Page Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/SpaLoginUi"
  title="SPA-style Login Page Sample"
  target="_blank"
/>
...
<LinkCard
  description="GitHub Repository for the Dynamic Providers Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/DynamicProviders"
  title="Dynamic Providers Sample"
  target="_blank"
/>
...
<LinkCard
  description="Adding Other Protocol Types To Dynamic Providers Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/WsFederationDynamicProviders"
  title="Adding Other Protocol Types To Dynamic Providers Sample"
  target="_blank"
/>
...
can be used together with the Duende dynamic identity providers feature.

The sample is minimalistic to show a simple Saml2 config and does not handle
the complete set of Saml2 config options.

<LinkCard
  description="GitHub Repository for the Using Sustainsys.Saml2 With Dynamic Providers Sample"
  href="https://github.com/Sustainsys/Saml2.Samples/tree/main/v2/DuendeDynamicProviders"
  title="Using Sustainsys.Saml2 With Dynamic Providers Sample"
  target="_blank"
/>
...
<LinkCard
  description="GitHub Repository for the Client Initiated Backchannel Login (CIBA) Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/Ciba"
  title="Client Initiated Backchannel Login (CIBA) Sample"
  target="_blank"
/>
...
Note there is some configuration in `Startup` with a call to `Configure<IISOptions>` (mainly to set
`AutomaticAuthentication` to `false`).

<LinkCard
  description="GitHub Repository for the Windows Authentication With IIS Hosting Sample"
  href="https://github.com/DuendeSoftware/Samples/tree/main/IdentityServer/v7/UserInteraction/WindowsAuthentication"
  title="Windows Authentication With IIS HostingSample"
  target="_blank"
/>