...
for [client authentication](/identityserver/tokens/client-authentication.md)
and [proof of possession](/identityserver/tokens/pop.md) API access.
...
This sample shows how to access APIs using DPoP for [proof of possession](/identityserver/tokens/pop.md#proof-of-possession-styles).
...
This sample shows how to enable [server-side sessions](/identityserver/ui/server-side-sessions/index.md) and configure the
basic settings.
