...
<LinkCard
description="GitHub Repository for the Model Context Protocol (MCP) Client Sample"
href="https://github.com/DuendeSoftware/samples/tree/main/IdentityServer/v7/McpDemo"
title="Model Context Protocol (MCP) Client Sample"
target="_blank"
/>
