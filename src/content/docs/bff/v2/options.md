...
* ***AnonymousSessionResponse*** (added in 2.0)
    ...
    This sets the response status code behavior on the [user endpoint](./session/management/user.md) to either return 401 or 200 with a *null* payload when the user is anonymous.
