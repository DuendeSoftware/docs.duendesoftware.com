...
Similarly to the [simple HTTP forwarder](/bff/v3/fundamentals/apis/remote#access-token-requirements), the allowed values for the token type are *User*, *Client*, *UserOrClient*. 
